 ...
 * Tag#isSameTag(Tag) for equality so as to ensure that the tag being added or updated is unique in terms of identity in
 * the UniqueTagList. However, the removal of a tag uses Tag#equals(Object) so as to ensure that the tag with exactly the
